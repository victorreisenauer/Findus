...
abstract class ExerciseState with _$ExerciseState {
  ...
  const factory ExerciseState.exerciseBuilt(Template builtExercise) = ExerciseBuilt;
  const factory ExerciseState.exerciseError(TemplateFailure error) = ExerciseError;
