...
abstract class LessonState with _$LessonState {
  ...
  const factory LessonState.lessonIdStreamLoaded(Stream<UniqueId> ids) = AllLessonIdsLoaded;
  const factory LessonState.lessonStarted(ObjectList<Exercise> exerciseList) = LessonStarted;
